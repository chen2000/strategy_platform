...
res_df[res_df['Trigger_name'] == 'trigger_macd_trend'].to_csv('data/sp500_MACD_trigger_table.csv', sep=',', index=False)

#sent emails
os.system('cat data/sp500_MACD_trigger_table.csv | mailx -s "Strategy Platform Trigger" \
